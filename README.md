...
**Para cualquier otro proveedor** (Hostalia, Nominalia, hosting propio...):
abre **⚙️ Configuración SMTP avanzada** y rellena los datos manualmente.
Pulsa **Guardar configuración email** antes de enviar.

**Ejemplo para Hostalia:**
...
Si ves este error al enviar, despliega **⚙️ Configuración SMTP avanzada** y activa
**No verificar certificado SSL**. Es habitual en hostings compartidos donde el
certificado SSL es wildcard y no coincide con el subdominio smtp.
